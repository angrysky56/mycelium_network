"""
Terrain layer implementation for the enhanced mycelium environment.

This module defines the TerrainLayer class which represents different
layers of the environment with distinct properties.
"""
